...
Before closing issue #24, download the new DMG through a browser on another Mac (or
a clean account), install Shipyard, and confirm it launches normally with quarantine
intact. Existing downloads are not retroactively signed or notarized. Enrollment,
credentials, and a real successful release are required to complete this check.
